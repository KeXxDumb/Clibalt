...
public class ThemeState {
    ...
    public static int background = 0xFFF4F4F4;
    public static int surface = 0xFFFFFFFF;
    public static int textPrimary = 0xFF1A1A1A;
    public static int textSecondary = 0xFF767676;
    public static int divider = 0xFFE0E0E0;

    private static final int[] LIGHT = {0xFFF4F4F4, 0xFFFFFFFF, 0xFF1A1A1A, 0xFF767676, 0xFFE0E0E0};
    private static final int[] DARK  = {0xFF161616, 0xFF212121, 0xFFF0F0F0, 0xFFAAAAAA, 0xFF3A3A3A};
