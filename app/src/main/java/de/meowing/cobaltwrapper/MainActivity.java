...
public class MainActivity extends Activity {
    ...
    // y escucha pegados manuales en el campo de texto principal.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Evita que videos entren a pantalla completa automáticamente sin que el usuario lo pida
        ...
        // Necesario para que Android le avise a onCreateWindow cuando la página
        // intenta abrir una pestaña/ventana nueva (window.open, target="_blank", etc.)
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, android.os.Message resultMsg) {
                // Creamos una WebView invisible y descartable solo para "leer" a dónde
                // intentaba navegar la pestaña nueva. Si es un archivo para descargar,
                // lo mandamos a nuestro gestor de descargas. Nunca se abre una pestaña real.
                WebView probeWebView = new WebView(MainActivity.this);
                probeWebView.setWebViewClient(new WebViewClient() {
                    @Override
                    public boolean shouldOverrideUrlLoading(WebView probeView, android.webkit.WebResourceRequest request) {
